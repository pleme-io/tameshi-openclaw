  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        resolvedDefaultFeatures = [ "chrono" "default" "dynamic-schema" "email-validator" "fast_chemail" "graphiql" "handlebars" "playground" "tempfile" "tracing" "tracing-futures" "tracinglib" ];
      };
      ...
      "sea-query" = rec {
        ...
        resolvedDefaultFeatures = [ "backend-mysql" "backend-postgres" "backend-sqlite" "bigdecimal" "chrono" "hashable-value" "ordered-float" "rust_decimal" "serde_json" "thread-safe" "time" "uuid" "with-bigdecimal" "with-chrono" "with-json" "with-rust_decimal" "with-time" "with-uuid" ];
      };
      ...
      "tokio-util" = rec {
        ...
        resolvedDefaultFeatures = [ "compat" "futures-io" "io" ];
      };
      "toml_datetime" = rec {
